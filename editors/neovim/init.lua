...
require('lazy').setup({
  ...
  'folke/zen-mode.nvim',  -- Distraction-free coding for Neovim >= 0.5
  'tpope/vim-repeat',     -- Repeat more things with "."
  'tpope/vim-sleuth',     -- Detect tabstop and shiftwidth automatically
  'tpope/vim-surround',   -- Tool for dealing with pairs of "surroundings."
...

  {
    ...
    vim.keymap.set('n', '<leader>dv', ":Gvdiffsplit!<cr>"),
  ...
  -- Integration with Ranger, console file manager with VI key bindings
  {
  ...
  -- }}}
  -- [[ Treesitter ]] (edit, and navigate code) {{{
  {
  ...
  -- }}}
  -- [[ Whichkey ]] {{{
  -- Useful plugin to show you pending keybinds, registers, etc.
  {
...
-- Save undo history, undo history location
vim.o.undofile = true
...
--
-- -- Spelling file location
-- vim.o.spellfile = "$HOME/.config/nvim/spell/spell.en.utf-8.add"
...
vim.keymap.set('n', "<c-s>", ":set spell<cr>[s1z=e")
