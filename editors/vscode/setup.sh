...
ln -s ~/Repositories/Github/raydennis/dotfiles/editors/vscode/settings.json ~/Library/Application\ Support/code/User/settings.json
ln -s ~/Repositories/Github/raydennis/dotfiles/editors/vscode/keybindings.json ~/Library/Application\ Support/code/User/keybindings.json
