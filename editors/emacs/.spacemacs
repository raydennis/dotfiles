...
you should place your code here."
  ...
  ;; Ranger: Show previews literally when ranger starts. The preview can also be toggled between literal and fully formatted, by pressing: zi.
  ...
  ;;vim style undo tree.  Invoke with SPC a u
  (global-undo-tree-mode 1)

  ;; enable Helm to manage the command buffer 
  (helm-mode 1)

  ;; helm settings (TAB in helm window for actions over selected items,
  ;; C-SPC to select items) (taken from https://juanjoalvarez.net/es/detail/2014/sep/19/vim-emacsevil-chaotic-migration-guide/)
  (require 'helm-config)
  (require 'helm-misc)
  ...
  ;; esc quits (from https://github.com/davvil/.emacs.d/blob/master/init.el)
...
then it takes a second \\[keyboard-quit] to abort the minibuffer."
  ...
  (define-key evil-normal-state-map (kbd "SPC o w") (lambda () (interactive) (find-file "~/notes/todo.org")))
